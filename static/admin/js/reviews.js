function loadStars(stars){
  ...
  calculatedStars.push(`<img src="{% static 'admin/img/star.png' %}>`)
}
  if(stars === 5){
...
function loadReviews(review){
  console.log(`
  <div class="review">
      <p class="review_name"><strong>${review_name}</strong></p>
      <div class="review_stars_column">
          <div class="review_stars">
              <img src="{% static 'admin/img/star.png' %}">
          </div>
          <div class="review_stars">
              <img src="{% static 'admin/img/star.png' %}">
          ...
          <p class="review_body">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquid distinctio tempore enim odit, quis praesentium, nobis alias sit nulla exercitationem eveniet doloremque asperiores doloribus voluptates eos natus placeat. Inventore, ab?</p>
      </div>
        `)
}

async function fetchReviews() {
  await fetch('admin/json/reviews.json')
  .then((response) => {
    if (!response.ok) {
